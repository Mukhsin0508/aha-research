...
function Footer() {
    return (
        <div id='contacts'
             className="  w-full h-[791px] xl:h-[470px]  pt-[60px] xl:pt-[90px] flex  flex-col items-center bg-blue -mt-[40px] ">

            <div
                className=" w-[328px] h-full flex flex-col items-start gap-[40px]  xl:w-[1200px] xl:flex-row xl:justify-between   ">
                <img src={LogoWhite} className=' w-[126px] h-[41px]  xl:' alt=""/>

                <div
                    className=' w-full h-[526px] flex flex-col items-start gap-10 xl:flex-row xl:w-[495px] xl:h-[267px]  '>
                    ...
                    <div className=' w-full  flex flex-col items-start gap-[32px] xl:min-w-[255px] '>
                        ...
                        <h2 className=' text-lg leading-[21px]  text-[#FEFEFE]'>Номер: {CONTACTS.phone}</h2>
                        <h2 className=' text-lg leading-[21px]  text-[#FEFEFE]'>Email: {CONTACTS.email} </h2>
                        <h2 className=' text-lg leading-[21px]  text-[#FEFEFE]'>Адрес: {CONTACTS.address}</h2>
                    </div>

                </div>

                <h1 className=' xl:hidden  text-lg leading-[21px]  text-[#F7F7FF]  mt-1'>{CONTACTS.copyright}</h1>
            </div>
            <div className=' sm:hidden xl:block w-[1200px] h-[80px] '>
                <h1 className='   text-lg leading-[21px]  text-[#F7F7FF]  mt-1'>{CONTACTS.copyright}</h1>
            </div>
